...
import 'package:ekram_project_dashboard_clinic/models/onBoardingInfoModel.dart';
      ...
      return Padding(
        ...
        child: Container(
          ...
          child: TextButton(onPressed:()async{
            ...
            Navigator.pushReplacement(context,MaterialPageRoute(builder: (context) => SubscribeToTheSystemScreen()) );
          } ,
